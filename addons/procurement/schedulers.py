...
class procurement_order(osv.osv):
    ...
    def _procure_confirm(self, cr, uid, ids=None, use_new_cursor=False, context=None):
        ...
        try:
            ...
            report_later = 0
            while True:
                ids = procurement_obj.search(cr, uid, [('state', '=', 'confirmed'), ('procure_method', '=', 'make_to_order')], offset=offset, limit=50, order='priority, date_planned', context=context)
            ...
            while True:
                report_ids = []
                ids = procurement_obj.search(cr, uid, [('state', '=', 'confirmed'), ('procure_method', '=', 'make_to_stock')], offset=offset, limit=50, order='priority, date_planned', context=context)
